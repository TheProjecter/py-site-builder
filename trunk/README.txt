...
result_dir -- directory where you want to put a working version of your project
get_sources_command -- command to checkout source of your project
stop_commands -- commands to stop web servers before saving working copy of your project to *result_dir*
start_commands -- commands to start web servers after saving working copy of your project to *result_dir*
